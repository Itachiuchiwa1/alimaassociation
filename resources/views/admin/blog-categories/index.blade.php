...
<div class="space-y-6">
  <div class="flex justify-between items-center">
    <h1 class="text-3xl font-bold">Catégories Blog</h1>
    ...
    <table class="w-full">
      <thead class="bg-gray-50 border-b border-gray-200">
        <tr>
          ...
          <th class="px-6 py-3 text-left text-sm font-semibold">Articles</th>
      ...
      <tbody class="divide-y divide-gray-200">
        @forelse($categories as $cat)
          <tr class="hover:bg-gray-50 transition">
            ...
            <td class="px-6 py-4 text-sm">{{ $cat->posts_count }}</td>
            <td class="px-6 py-4 text-sm space-x-2">
              ...
              <form action="{{ route('admin.blog-categories.destroy', $cat) }}" method="POST" class="inline-block"
        ...
        @empty
          <tr>
            <td colspan="3" class="px-6 py-12 text-center text-gray-500">
              Aucune catégorie. <a href="{{ route('admin.blog-categories.create') }}" class="text-[var(--color-primary)] hover:underline">Créer la première</a>.
            </td>
          </tr>
        @endforelse
      </tbody>
